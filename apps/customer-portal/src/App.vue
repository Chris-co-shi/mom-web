...
<template>
  <PortalShell subtitle="Phase 02 Ready" title="客户协同门户">
    ...
    <Page
      ...
      description="当前主体由 IAM 固定绑定；页面不提供 Customer ID 输入、选择或切换。"
      title="客户协同门户"
    >
      <template #context>
